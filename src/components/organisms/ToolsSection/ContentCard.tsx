...
const ContentCard = () => {
  return (
    <div className="pointer-events-auto flex flex-1 min-h-75.75 flex-col items-center justify-center gap-3 bg-white/95 backdrop-blur-[1px] border border-[rgba(114,123,142,0.1)]">
      <div className="flex flex-col items-start gap-3">
        <span className="font-mono font-semibold text-[12px] leading-5.25 tracking-[0.09em] uppercase text-[#8E90A1]">
          FERRAMENTAS
        </span>

        <h2 className="font-itc-garamond-std font-light text-[28px] leading-8.5 text-[#434A57]">
