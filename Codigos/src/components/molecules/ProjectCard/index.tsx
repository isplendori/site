  ...
  return (
    <>
      <Wrapper
        ...
        className={cn(
          "relative block w-full md:w-[563.5px] h-94.75 rounded-[14px] overflow-hidden border border-[rgba(114,123,142,0.1)] dark:border-[rgba(255,255,255,0.1)] bg-[rgba(114,123,142,0.05)] group",
          href && "cursor-pointer",
          className
        )}
