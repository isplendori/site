...
const PlansSection = ({
  ...
  return (
    <section
      className={cn(
        "box-border flex flex-col justify-center items-center p-0 gap-13.5 w-full bg-white border-x border-[rgba(114,123,142,0.1)] pt-10 pb-24",
        className
      )}
    >
      <div className="flex flex-col justify-center items-center p-0 gap-4.25 w-181.5 max-w-full py-14.5">
        <div className="flex flex-col justify-center items-center p-0 w-131 max-w-full">
          ...
          {title && (
            <h2 className="font-itc-garamond-std font-light text-[36px] leading-10.75 text-[#434A57] text-center">
              {title}
            </h2>
          )}
        </div>
      ...
      <div className="flex flex-row justify-center items-start p-0 gap-2.5 w-291.5 max-w-full">
        <div className="box-border flex flex-row items-start p-[17px_29px_32px] gap-2.5 w-114.5 h-120.25 bg-white border border-[rgba(114,123,142,0.1)] rounded-[20px]">
          <div className="relative flex flex-col justify-end items-start p-0 w-100 h-108">
            ...
            <div className="relative z-10 flex flex-col items-start p-0 gap-11.25 w-41.5">
              <Link
                ...
                className="flex flex-row justify-center items-center px-4 py-2 gap-2.5 w-41.5 h-9 bg-[#12141B] border border-[rgba(114,123,142,0.1)] rounded-[200px] hover:bg-[#1c1f29] transition-colors"
              >
                <span className="w-[10.46px] h-[10.46px] bg-[#9E372A]" aria-hidden="true" />
                <span className="font-sans font-medium text-[14px] leading-5 text-center text-white flex items-center">
                  {freePlan.ctaText}
                </span>
              </Link>
        ...
        <div className="relative flex flex-col items-start p-[43px_34px] gap-5.75 w-174.5 h-120.25 overflow-hidden rounded-[20px] border border-[rgba(114,123,142,0.1)] bg-[#0B0C10]">
          <div
          ...
          <div className="relative z-10 flex flex-col items-start p-0 gap-2.5 w-139.5 max-w-full">
            <div className="flex flex-row justify-between items-center p-0 w-full">
              <h3 className="font-sans font-medium text-[24px] leading-7.5 text-white">
                {monthlyPlan.title}
              </h3>
            </div>
          </div>
          ...
          <div className="relative z-10 w-157.5 max-w-full">
            <div className="absolute left-16.5 -top-4 z-20 flex flex-col justify-center items-center px-2.5 py-2.5 bg-[#202026] border border-[rgba(114,123,142,0.1)] rounded-sm">
              <span className="font-mono font-semibold text-[12px] leading-5.25 tracking-[0.09em] uppercase text-[#727B8E]">
                {monthlyPlan.includedLabel}
              </span>
            </div>

            <div className="flex flex-col items-start p-8 w-full bg-white rounded-lg shadow-[inset_0px_1px_0.25px_rgba(255,255,255,0.16),inset_0px_2px_1px_rgba(255,255,255,0.11)]">
          ...
          <div className="relative z-10 flex flex-row items-end p-0 gap-1 mt-auto">
            <span className="font-sans font-medium text-[40px] leading-14 tracking-[-2px] text-white">
              {monthlyPlan.price}
            </span>
            <span className="font-sans font-normal text-[14px] leading-5 text-white">
      ...
      <div className="flex flex-row items-center p-0 gap-4.25 w-291 max-w-full">
        {guarantees.map((guarantee) => (
          <div
            key={guarantee.title}
            className="box-border flex flex-col justify-center items-center px-0 py-2 gap-2.5 flex-1 h-42 bg-white border border-dashed border-[rgba(114,123,142,0.28)] rounded-[20px]"
          >
            <div className="flex flex-row items-center p-0 gap-2.5 w-116.5 max-w-full">
              <div className="shrink-0">
                <CheckCircleIcon />
              </div>
              <h3 className="font-itc-garamond-std font-light text-[24px] leading-7.25 text-[#434A57]">
                {guarantee.title}
              </h3>
            </div>
