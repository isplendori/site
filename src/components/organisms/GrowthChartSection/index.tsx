          ...
          <div className="absolute inset-0 flex">
            {data.map((item) => (
              <div key={item.month} className="relative flex-1 flex flex-col items-center">
                <div className="absolute bottom-4 text-[14px] leading-[22.4px] tracking-[-0.28px] text-[#727B8E]">
                  {item.month}
                </div>
              </div>
            ))}
        ...
        <div className="w-full h-40 flex border-t border-[rgba(114,123,142,0.06)]">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-[14px] leading-[22.4px] tracking-[-0.28px] text-[#727B8E]">
                {stat.label}
              </div>
            </div>
          ))}
