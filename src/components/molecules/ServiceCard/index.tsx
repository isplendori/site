...
const ServiceCard = ({ title, description, className }: ServiceCardProps) => {
  return (
    <div
      className={cn(
        "box-border flex flex-row justify-center items-center p-[8px_16px] gap-2.5 h-48.75 bg-white border-dashed border-[rgba(114,123,142,0.28)]",
        className
      )}
    >
      <div className="flex flex-col items-start p-0 gap-4.5 w-65.5 h-31">
        <div className="box-border flex flex-row justify-center items-center p-0 gap-2.5 w-11 h-11 bg-white border border-[rgba(114,123,142,0.1)] rounded-sm">
