...
const projects = [
  { title: "Nome do Projeto", category: "DESIGN" },
  { title: "Nome do Projeto", category: "DESIGN" },
  { title: "Nome do Projeto", category: "DESIGN" },
  { title: "Nome do Projeto", category: "DESIGN" },
  { title: "Nome do Projeto", category: "DESIGN" },
  ...
  return (
    <MainLayout>
      <div className="flex w-full max-w-304 mx-auto flex-col items-center px-4 sm:px-0 sm:border-x border-[rgba(114,123,142,0.1)]">
        ...
        <div className="flex flex-col items-center justify-center w-full h-full relative border-b border-[rgba(114,123,142,0.1)]">
