...
const defaultTitle = (
  <>
    <span className="block">Sua marca já mostra</span>
    <span className="block">
      onde está o <span className="italic text-[#9E372A]">ruído</span>
    </span>
  </>
);

const defaultDescription =
  "Em uma conversa direta, entendemos o que trava sua presença hoje e apontamos o primeiro movimento com mais clareza. Sem apresentação inflada.";

const FinalCtaSection = ({
  className,
  badge = "PRONTO PARA OLHAR COM CRITÉRIO?",
  title = defaultTitle,
  description = defaultDescription,
  buttonText = "Fazer diagnóstico",
  buttonHref = "/diagnostico",
  buttonExternal = false,
  floatingMessages = ["A CLAREZA COMEÇA AQUI."],
