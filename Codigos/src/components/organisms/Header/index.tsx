    ...
    >
      <div className="flex flex-row items-center justify-between w-full max-w-302.5">
        ...
        <div className="flex flex-row items-center gap-4 h-10">
          ...
          >
            <div className="flex flex-row items-center gap-1.5 h-6.5">
              <span className="flex h-6.5 items-center font-sans text-[15px] font-normal not-italic leading-6.5 text-[#202026] transition-colors group-hover:text-white dark:text-[#F1F2F4]">
                Já sou cliente
              </span>
              <div className="w-2 h-2 [&_path]:group-hover:stroke-white [&_path]:transition-colors">
                <ArrowUpRight stroke="#1A1A20" strokeDasharray="1.2 1.2" />
              </div>
            </div>
          </Link>
