  ...
  return (
    <Link
      ...
      className={`flex flex-col justify-center items-center p-3.5 gap-6.75 w-full h-22.5 rounded-lg transition-colors ${
        active
          ? "bg-[rgba(230,144,144,0.14)] border border-[rgba(114,123,142,0.1)] hover:bg-[rgba(230,144,144,0.2)]"
          : "bg-white hover:bg-[rgba(0,0,0,0.05)]"
      }`}
    >
      <div className="flex flex-row items-start gap-4.5 w-81 h-15.5">
        <div className={`flex flex-row justify-center items-center w-11 h-11 border border-[rgba(114,123,142,0.1)] rounded-sm ${
          active ? "bg-[rgba(230,144,144,0.24)]" : "bg-white"
        }`}>
          <Image
